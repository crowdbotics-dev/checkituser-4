"""
Django settings for checkituser_4 project.
...
ROOT_URLCONF = 'checkituser_4.urls'
...
WSGI_APPLICATION = 'checkituser_4.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "checkituser_4 API",
    "DESCRIPTION": "API documentation for checkituser_4 App",
    "VERSION": "v1",
}
